package yaumrrefactored.interactors.tests;
...
import yaumrrefactored.core.BlockPlacementTerraformingTool;
import yaumrrefactored.core.TerraformingTool;
import yaumrrefactored.core.tests.mocks.IslandManipulationFacadeMock;
import yaumrrefactored.core.tests.mocks.TerraformingToolMock;
import yaumrrefactored.interactors.InteractionVector;
import yaumrrefactored.interactors.TerraformingToolsSelector;
...
public class TerraformingToolsSelectorTest {
    ...
    public TerraformingToolsSelectorTest() {
    }
